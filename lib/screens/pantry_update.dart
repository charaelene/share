...
class PantryUpdate extends StatefulWidget {
  ...
  const PantryUpdate({super.key});

  @override
  State<PantryUpdate> createState() => _PantryEditorState();
}

class _PantryEditorState extends State<PantryUpdate> {
